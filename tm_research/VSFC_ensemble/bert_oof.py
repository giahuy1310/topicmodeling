"""K-fold OOF + full-train refit for HuggingFace BERT models on UIT-VSFC (3-class).

PhoBERT, CafeBERT, and ViBERT notebooks call ``run_bert_oof`` with different
``model_name`` / ``output_name``; artifacts go to ``VSFC_ensemble/artifacts/``.
"""
